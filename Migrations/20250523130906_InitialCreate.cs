        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentCourseAssignments_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentAssignmentStatuses_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentAssignmentStatuses_Assignments_AssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAssignmentStatuses_AssignmentId",
                table: "StudentAssignmentStatuses",
                column: "AssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentAssignmentStatuses_StudentId",
                table: "StudentAssignmentStatuses",
                column: "StudentId");
